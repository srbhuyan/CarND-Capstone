...
MAX_SPEED = 5 # The actrual speed is 2x MAX_SPEED. I don't know why. Please seet this value < 10 or the controller cannot follow and the I controller would not work properly..
